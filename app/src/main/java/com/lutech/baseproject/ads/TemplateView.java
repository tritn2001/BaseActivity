...
import com.lutech.baseproject.ads.NativeTemplateStyle;
...
public class TemplateView extends FrameLayout {
    ...
    public void setCallToActionViewBackground(int color, int colorText) {
        this.callToActionView.setBackgroundResource(color);
        this.txtAds.setBackgroundColor(colorText);
    }
...
//        }
    ...
    public void onFinishInflate() {
        ...
        background = (LinearLayoutCompat) findViewById(R.id.background);
        txtAds = (TextView) findViewById(R.id.txtAds);
